...
async function Update(){
    ...
    let Ethprice = Number(await fetch('https://api.coingecko.com/api/v3/simple/price?ids=ethereum&vs_currencies=usd'));
    console.log((0.03)*((document.getElementById('Millions').value)*(1000000))/(document.getElementById("EthCount").value * Ethprice) * 100);
    document.getElementById("%").innerText = (0.03)*((document.getElementById('Millions').value)*(1000000))/(document.getElementById("EthCount").value * Ethprice) * 100;
}
